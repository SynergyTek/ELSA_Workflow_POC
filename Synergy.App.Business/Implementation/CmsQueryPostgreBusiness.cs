...
//{
//    public class CmsQueryPostgreBusiness : BaseBusiness<TemplateViewModel, Template>, ICmsQueryBusiness
//    {
...
//            selectQuery.Append(@$"""LastUpdatedBy""='{Guid.Parse(_repo.UserContext.UserId)}'{Environment.NewLine}");
