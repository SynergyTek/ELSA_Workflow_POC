...
//{
//    public class RepositoryPostgresBase<V, D> : IRepositoryBase<V, D> where V : BaseModel where D : BaseModel
//    {
...
//       // private IContextBase _dbContext;
...
//        public RepositoryPostgresBase(DbContextOptions<IContextBase<UserViewModel,User>> dbOptions,
...
//        //public async Task<string> UploadMongoFile(string fileName, byte[] bytes, string ContentType)
//        //{
//        //    //var fileDB = _configuration.GetSection("Settings");
//        //    var fileDB = _configuration.GetConnectionString("FileDatabase");
//        //    if (fileDB == "s3")
//        //    {
//        //        var bucketName = _configuration.GetConnectionString("S3bucketName");
//        //        var result = await Uploads3FileAsync(bytes, bucketName, ContentType);
//        //        return result;
//        //    }
//        //    else
//        //    {
...
//        //    }
//        //}
//        //public string GenerateMongoIdByFileName(string fileName)
//        //{
...
//        //public async Task<string> Uploads3FileAsync(byte[] bytes, string bucketName, string ContentType)
//        //{
//        //    try
//        //    {
...
//        //        {
//        //            var bucketName = _configuration.GetConnectionString("S3bucketName");
//        //            return await Gets3FileByKeyAsync(bucketName, id);
//        //        }
//        //        else
//        //        {
...
//        //}
//        //public async Task<Stream> DownloadMongoStream(string id)
//        //{
//        //    try
//        //    {

//        //        var objId = ObjectId.Parse(id);
//        //        var x = await _gridFs.OpenDownloadStreamAsync(objId);
//        //        return x;
...
//        //public async Task<byte[]> Gets3FileByKeyAsync(string bucketName, string key)
//        //{
//        //    try
//        //    {
//        //        var bucketExists = await _s3Client.DoesS3BucketExistAsync(bucketName);
...
//        public async Task<List<VM>> GetList<VM, DM>() where VM : BaseModel where DM : BaseModel
//        {
//            var context = GetDbContext();
//            try
//            {

//                var data = await context.Set<DM>().AsNoTracking().Where(x => x.IsDeleted == false).ToListAsync();
...
//        public async Task<List<VM>> GetList<VM, DM>(Expression<Func<DM, bool>> where, params Expression<Func<DM, object>>[] include) where VM : BaseModel where DM : BaseModel
//        {
...
//        public async Task<VM> GetSingle<VM, DM>(Expression<Func<DM, bool>> where, params Expression<Func<DM, object>>[] include) where VM : BaseModel where DM : BaseModel
//        {
//            where = AndAlso<DM>(x => x.IsDeleted == false , where);
//            var context = GetDbContext();
//            try
...
//        public async Task<VM> GetSingleById<VM, DM>(string id, params Expression<Func<DM, object>>[] include) where VM : BaseModel where DM : BaseModel
//        {
//            var context = GetDbContext();
//            try
//            {
...
//        }
//        private async Task<DM> GetSingleByIdWithTracking<DM>(string id) where DM : BaseModel
//        {
//            var context = GetDbContext();
//            try
//            {
...
//        public async Task<VM> Create<VM, DM>(VM model, bool autoCommit = true) where VM : BaseModel where DM : BaseModel
//        {
//            model.CreatedDate = DateTime.Now;
//            model.LastUpdatedDate = DateTime.Now;
//            if (model.CreatedBy!=Guid.Empty)
//            {
//                model.CreatedBy = Guid.Parse(UserContext.UserId);
//            }
//            if (model.LastUpdatedBy != Guid.Empty)
//            {
//                model.LastUpdatedBy = Guid.Parse(UserContext.UserId);
//            }
...
//        public static async Task CreateMaster<DM>(PostgreDbContext context, DM baseModel) where DM : BaseModel
//        {
//            await context.Set<DM>().AddAsync(baseModel);
//        }
//        //private async Task CreateLog<DM>(PostgreDbContext context, DM baseModel) where DM : BaseModel
//        //{
//        //    try
//        //    {
...
//        private async Task EditMaster<DM>(PostgreDbContext context, DM existingItem) where DM : BaseModel
//        {
...
//            }
//        }
//        public DL MapLog<SL, DL>(SL source) where SL : BaseModel where DL : BaseModel
//        {
//            try
//            {
...
//            }
//        }
//        public DL MapDictionaryLog<DL>(string json) where DL : BaseModel
//        {
//            try
//            {
...
//        public ContextBase GetDbContext()
//        {
//            //if (_dbContext == null)
//            //{
...
//        public async Task<VM> CreateMigrate<VM, DM>(VM model, bool autoCommit = true) where VM : BaseModel where DM : BaseModel
//        {

//            model.CreatedDate = DateTime.Now;
//            model.LastUpdatedDate = DateTime.Now;
//            model.CreatedBy = Guid.Parse("1");
//            model.LastUpdatedBy = Guid.Parse("1");
//           // model.CompanyId = Guid.Parse("1");
...
//        public async Task<List<VM>> CreateMany<VM, DM>(List<VM> models, bool autoCommit = true) where VM : BaseModel where DM : BaseModel
//        {
...
//        public async Task<VM> Edit<VM, DM>(VM model, bool autoCommit = true) where VM : BaseModel where DM : BaseModel
//        {
//            var existingItem = await GetSingleById<DM, DM>(model.Id.ToString());
...
//        public async Task<VM> GetSingleGlobal<VM, DM>(Expression<Func<DM, bool>> where, params Expression<Func<DM, object>>[] include) where VM : BaseModel where DM : BaseModel
//        {
//            var context = GetDbContext();
//            try
//            {
...
//        public async Task Delete<VM, DM>(string id, bool autoCommit = true) where VM : BaseModel where DM : BaseModel
//        {
...
//        public async Task<List<VM>> GetListGlobal<VM, DM>(Expression<Func<DM, bool>> where, params Expression<Func<DM, object>>[] include) where VM : BaseModel where DM : BaseModel
//        {
//            var context = GetDbContext();
//            try
//            {
...
//        public async Task<List<VM>> GetListGlobal<VM, DM>() where VM : BaseModel where DM : BaseModel
//        {
//            var context = GetDbContext();
//            try
//            {
