...
//        public RepositoryPostgresDapperQueryBase(IUserContext userContext, IConfiguration configuration, IMapper autoMapper)
//        {
...
//        public async Task<V> ExecuteQuerySingle(string query, object prms)
//        {
//            return await ExecuteQuerySingle<V>(query, prms);
//        }

//        public async Task<List<V>> ExecuteQueryList(string query, object prms)
//        {
...
//            using (var conn = DbConnection())
//            {
//                var result = await conn.ExecuteAsync(query, prms);
//                //return result.ToList().ToDataTable();
//            }
...
//        public async Task<VM> ExecuteQuerySingle<VM>(string query, object prms)
//            where VM : class, new()
//        {
//            try
//            {
//                using (var conn = DbConnection())
//                {
//                    var result = await conn.QueryAsync<VM>(query, prms);
//                    return result.FirstOrDefault();
//                }
//            }
//            catch (Exception ex)
...
//        public async Task<List<VM>> ExecuteQueryList<VM>(string query, object prms)
//          where VM : class, new()
//        {
//            try
//            {
...
//        public async Task<VM> ExecuteScalar<VM>(string query, object prms)
//        {
//            using (var conn = DbConnection())
//            {
//                var result = await conn.QueryAsync<VM>(query, prms);
...
//        public async Task<List<VM>> ExecuteScalarList<VM>(string query, object prms)
//        {
//            using (var conn = DbConnection())
//            {
//                var result = await conn.QueryAsync<VM>(query, prms);
