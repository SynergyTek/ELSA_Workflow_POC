...
//{
//    public class TableMetadataBusiness : BaseBusiness<TableMetadataViewModel,TableMetadata>, ITableMetadataBusiness
//    {
...
//        private ColumnMetadataViewModel AddColumn(ColumnMetadataViewModel col, TableMetadataViewModel table, DataActionEnum dataAction, IRepositoryBase<TableMetadataViewModel, TableMetadata> _repo)
//        {
//            col.Id = Guid.NewGuid();
//            col.CreatedBy =Guid.Parse(_repo.UserContext.UserId);
//            col.CreatedDate = DateTime.Now;
//            col.LastUpdatedBy = Guid.Parse(_repo.UserContext.UserId);
...
//                table.TemplateId = model.Id.ToString();
