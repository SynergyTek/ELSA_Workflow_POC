...
public static class Extension
{
    ...
    public static string HintFromResult(this string code) => code switch
    {
        ...
        "MultipleFacesFound" =>
            "We found multiple faces or a strongly uneven background distracted us. Your face should fill the circle completely.",
        "UnsuitableImage" =>
            "We did not find a suitable face. Please position your face in the center and make sure you are fully visible. ",
        "UnnaturalMotionDetected" =>
            "We observed unnatural motion. Please make sure to look straight in the first picture, then nod your head slightly.",
    ...
    public static string ToSentenceCase(this string str)
    {
        ...
        return System.Text.RegularExpressions.Regex.Replace(str, "[a-z][A-Z]",
            m => $"{m.Value[0]} {char.ToUpper(m.Value[1])}");
    }
    ...
    public static string ToDatabaseDateFormat(this DateTime? value)
    {
        ...
        return value.Value.ToDatabaseDateFormat();
    }
    ...
    public static string ToYYYY_MM_DD_HH_MM_DateFormat(this DateTime value)
    {
        return String.Format(ApplicationConstant.DateAndTime.DefaultYY_MM_DD_HH_MM_SS, value);
    }
    ...
    public static string ToMM_DD_YYYY_HH_MM_SS(this DateTime value)
    {
        return String.Format(ApplicationConstant.DateAndTime.DefaultMM_DD_YYYY_HH_MM_SS, value);
    }
    ...
    public static IList<SelectListItem> GetYearList(string value)
    {
        ...
        while (currentYear >= ApplicationConstant.ApplicationStartYear)
        {
            list.Add(new SelectListItem
            {
                ...
                Selected = currentYear.ToString() == value
            });
            currentYear--;
        }
    ...
    private static List<double> ExtractRGBAValues(string colorString)
    {
        ...
        List<double> rgbaValues = colorString.Split(',')
            .Select(sC => double.Parse(sC.Trim(), System.Globalization.CultureInfo.InvariantCulture)).ToList();
        return rgbaValues;
    }
    ...
    public static string GenerateGradientColor(string startColor, string endColor, double valueP)
    {
        ...
        List<ColorPercentage> percentColors =
            new List<ColorPercentage>
            {
                new() { Percentage = 0.0, R = rMin, G = gMin, B = bMin, A = aMin },
                new() { Percentage = 1.0, R = rMax, G = gMax, B = bMax, A = aMax }
            };
        ...
        ColorPercentage lower = percentColors[i - 1];
        ColorPercentage upper = percentColors[i];
